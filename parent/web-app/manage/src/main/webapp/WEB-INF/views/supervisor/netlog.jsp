...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
						<div id="toolbar" class="well">
							<form id="form-netlog-seach" role="form" class="form-inline">
								<div class="form-group">
									<label for="exampleInputEmail2" class="sr-only">查询条件</label>
									<input name="wordKey" type="text" placeholder="场所编码 / 场所编号 / 手机号" class="form-control">
								</div>
								<button id="btn-search-netlog" class="btn btn-primary" type="button" data-loading-text="查询中..." autocomplete="off" style="margin-bottom: 0px;">
									&nbsp;查询&nbsp;
								</button>
						...
						<table id="netlog-table"
							...
							data-query-params="Netlog.seachFlowParams">
							<thead>
								<th data-field="uAccount">手机号</th>
								<th data-field="qqNumber">用户MAC</th>
								<th data-field="phoneNumber">网址</th>
								...
								<th data-field="phoneNumber">外网IP</th>
								<th data-field="phoneNumber">目的IP</th>
							</thead>
						</table>
		            </div>
		        </div>
	...
	<script src="<%=basePath%>moojs/supervisor/netlog.js?v=1"></script>
