...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
						<div id="toolbar" class="well">
							<form id="form-netplay-seach" role="form" class="form-inline">
								<div class="form-group">
									<label for="exampleInputEmail2" class="sr-only">查询条件</label>
									<input name="wordKey" type="text" placeholder="用户MAC/ 内网IP / 手机号" class="form-control">
								</div>
								<button id="btn-search-netplay" class="btn btn-primary" type="button" data-loading-text="查询中..." autocomplete="off" style="margin-bottom: 0px;">
									&nbsp;查询&nbsp;
								</button>
						...
						<table id="netplay-table"
							...
							data-query-params="Netplay.seachFlowParams">
							<thead>
								<!-- <th data-checkbox="true"></th> -->
								<!-- <th data-field="uState">编辑</th> -->
								<th data-field="uAccount">认证类型</th>
								<th data-field="qqNumber">认证账号</th>
								<th data-field="phoneNumber">场所编码</th>
								<th data-field="phoneNumber">场所名称</th>
								<th data-field="regDate" data-formatter="dateTime_formatter">上线时间</th>
								<th data-field="phoneNumber">内网IP</th>
								<th data-field="phoneNumber">设备MAC</th>
	...
	<script src="<%=basePath%>moojs/supervisor/netplay.js?v=1"></script>
