...
public class RandImage extends HttpServlet  {
    ...
    public static final String RAND_KEY = "session_rand";
	...
	char[] codeSequence = { '1', '2', '3', '4', '5', '6', '7', '8', '9', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J',
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		session.setAttribute(RAND_KEY, randomCode.toString());
